...
const TOPICS = [
  ...
  { keywords: ["times คืออะไร", "t.i.m.e.s คืออะไร", "t.i.m.e.s. คืออะไร", "แอปนี้", "โปรแกรมนี้"], answer: "T.i.M.E.S. คือแอปวางแผนเวลาส่วนตัว ที่ช่วยให้เห็นทั้งสิ่งที่วางแผนไว้และสิ่งที่ต้องติดตาม โดยไม่ทำให้ทุกบล็อกเวลาเป็นการแจ้งเตือนครับ\n\n1. ภาพรวมการวางแผน — วางกิจกรรมลงตารางตามวันและเวลา ดูได้ทั้งรายสัปดาห์และ Cycle 4 สัปดาห์ พร้อมหมวดหมู่และ Tag เพื่ออ่านแผนได้ง่าย\n\n2. การเชื่อมต่อและข้อมูล — เลือกเชื่อม Google Calendar เพื่อจัดการกิจกรรม และ Telegram เพื่อรับการแจ้งเตือนได้ ข้อมูลหลักแยกตามบัญชีผู้ใช้และซิงก์ไปยังอุปกรณ์ที่ออนไลน์บัญชีเดียวกัน\n\n3. สองโหมดหลัก — Activity Mode ใช้วางและแก้ไขบล็อกเวลาของกิจกรรมจริง ส่วน Reminder Mode ใช้ติดตามหรือแจ้งเตือนสิ่งที่ต้องทำ ทั้งสองโหมดแยกหน้าที่กัน แต่เชื่อมกับมุมมองเวลาเดียวกันครับ" }
];
