...
const TOPICS = [
  ...
  { keywords: ["times คืออะไร", "t.i.m.e.s คืออะไร", "t.i.m.e.s. คืออะไร", "แอปนี้", "โปรแกรมนี้"], answer: "T.i.M.E.S. เป็นแอปวางแผนเวลาส่วนตัวที่แยกกิจกรรมตามตารางออกจาก Reminder แล้วเชื่อมทั้งสองส่วนเข้ากับมุมมองเวลาเดียวกันครับ ใช้วางกิจกรรม ติดตามสิ่งที่ต้องทำ และเลือกเชื่อม Google Calendar หรือ Telegram ได้" }
];
