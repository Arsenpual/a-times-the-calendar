...
// ให้ Function อยู่ภูมิภาคเดียวกับ Firestore default database ของโปรเจกต์
// (`asia-southeast3` / Bangkok) เพื่อลด latency และหลีกเลี่ยงทรัพยากร
// serverless ข้ามภูมิภาคโดยไม่จำเป็น.
